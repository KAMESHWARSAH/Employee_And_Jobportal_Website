...
<section>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="navbar-brand"  style="color: white"><button onclick="document.getElementById('id011').style.display='block'" style="width:auto;">ADMIN LOGIN</button></a>
      </li>
...
$usql="SELECT * from `admin` where `mobile`='$user' AND `password`='$pass'";

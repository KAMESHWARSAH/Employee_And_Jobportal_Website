...
<!----- table sectio ---------------------------->
<section>
	<h1 class="h-primary center">SHOP AND MALL </h1>
  <div>
  ...
  <thead class="thead-dark">
    <tr>                 
      ...
      <th scope="col">SMOBILENO</th>
      <th scope="col">SEMAIL</th>
      <th scope="col">SWEBSITE</th>
...
?>
  <tbody>
    <tr>
      ...
      <th scope="col"><button>DELATE</button></th>
    </tr>
...
<section>
  <div>
    <h1 class="h-primary center">COMPANY </h1>
  </div>
  <!----- table sectio ---------------------------->
<section>
  <div>
